...
public class RandomAreaSpawner : MonoBehaviour
{
    ...
    public RandomSpawnerShape sphereShape = RandomSpawnerShape.Sphere;
    public RandomSpawnerShape boxShape = RandomSpawnerShape.Box;
    ...
    void Start()
    {
        if (prefab != null)
        {
            ...
            {
                CreateAsteroid(sphereShape);
                CreateAsteroid(boxShape);
            }
        }
    }
        ...
        //{
            ...
            //{
               //CreateAsteroid(sphereShape);
                //CreateAsteroid(boxShape);
            //}
            //starCraft.transform.position.x;
        //}
    }
    private void CreateAsteroid(RandomSpawnerShape spawnShape)
    {
    ...
    {
        CreateAsteroid(RandomSpawnerShape.Sphere);
    }
}
