...
namespace BGC.Annotation.Basic{
    ...
    public class Spot : Annotation
    {
        ...
        {
            GameObject spotInstance = new GameObject();
            if (Physics.Raycast(
                 ...
                 Physics.DefaultRaycastLayers))
            {
                ...
                Debug.Log("Spot : spotInstance.tag = " + spotInstance.tag);
                if (spotInstance != null) { 
                    spotInstance = Instantiate(spotInstance, hitInfo.point, Quaternion.identity);
